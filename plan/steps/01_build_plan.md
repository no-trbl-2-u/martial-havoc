...
- [-] Phase 8 — The UI (canonical sibling: `/critique` starts after this
      phase ships; set via oversight 2026-09-05) — 8a shipped d4ab97f:
      three candidate layouts at `?layout=a|b|c`, screenshotted to
      `design/screenshots/layouts/`. 8b waits on the operator's pick
      (`[needs-user-call]`, the row's own procedure).
